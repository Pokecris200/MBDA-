...
ALTER TABLE bien ADD CONSTRAINT CK_Codigo CHECK (codigo LIKE ('%0' OR '%1')AND (SUBSTRING(codigo,0,2) = UPPER(SUBSTRING(codigo,0,2))) AND SUBSTRING(codigo,2,2) SIMILAR TO '[0-9]*');
